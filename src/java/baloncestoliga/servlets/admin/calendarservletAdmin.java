 ...
 * @author inftel07
 */
@WebServlet(name = "calendarservletAdmin", urlPatterns = {"/calendarservletAdmin"})
public class calendarservletAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/adminjsp/GestPartidos.jsp");
