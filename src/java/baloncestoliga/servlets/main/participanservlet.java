 ...
 */
package baloncestoliga.servlets.main;
 ...
 * @author inftel07
 */
@WebServlet(name = "participanservlet", urlPatterns = {"/participanservlet"})
public class participanservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/jsp/participan.jsp");
